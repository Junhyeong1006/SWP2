...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.pushButton = QtWidgets.QPushButton(Dialog) # no
        ...
        self.pushButton_2 = QtWidgets.QPushButton(Dialog) # mr
        ...
        self.pushButton_3 = QtWidgets.QPushButton(Dialog) # al
    ...
    def playGame(self):
            ...
            for k in range(len(self.numlist)):
                if self.numlist[k] == 1:
                    self.pushButton.setStyleSheet("background-color: #FFD400")
                    QtTest.QTest.qWait(breaktime)
                elif self.numlist[k] == 2:
                    self.pushButton_2.setStyleSheet("background-color: #FFD400")
                    QtTest.QTest.qWait(breaktime)
                elif self.numlist[k] == 3:
                    self.pushButton_3.setStyleSheet("background-color: #FFD400")
                    QtTest.QTest.qWait(breaktime)
                elif self.numlist[k] == 4:
                    self.pushButton_4.setStyleSheet("background-color: #FFD400")
                    QtTest.QTest.qWait(breaktime)
